        ...
        <div style={{position: 'absolute', left: 110, right: 110, top: 368}}>
          ...
          <div style={{display: 'grid', gridTemplateColumns: `repeat(${progressCount}, minmax(0, 1fr))`, gap: 20, marginTop: 46}}>
            {data.progress.map((item, index) => (
              <div key={`${index}-${item.title}`} style={{padding: '24px 25px', borderRadius: R.inner, background: material.sunken, boxShadow: neo.inset, display: 'flex', alignItems: 'center', gap: 18}}>
